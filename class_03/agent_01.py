...
# Print a message
print("Don't forget to check OpenAI model before asking anything because it's cost a lot. (gpt-4.1 (mostly use this model if gpt-4.1-mini doesn't work) or gpt-4.1-mini-2025-04-14)")
